      ...
      <div className="flex gap-3 mb-4">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 bg-[#1A1A1A] border border-white/15 rounded-lg text-sm text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-[#DC143C]/40 focus:border-[#DC143C]"
          />
        </div>
                  ...
                  >
                    <td className="px-4 py-3">
                      <Link href={`/contacts/${lead.id}`} className="block">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className="text-sm font-semibold text-white group-hover:text-gray-300 transition-colors">
                              {lead.name}
                            </p>
                    ...
                    <td className="px-4 py-3 hidden md:table-cell">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-sm text-gray-500">{formatInstrument(lead.instrument)}</span>
                      </div>
                    </td>
                    <td className="px-4 py-3">
                    ...
                    <td className="px-4 py-3 hidden lg:table-cell">
                      <span className="text-sm text-gray-500">{lead.assignedTo}</span>
                    </td>
                    <td className="px-4 py-3 hidden lg:table-cell">
                      <span className="text-sm text-gray-600">{formatDate(lead.lastContactDate)}</span>
                    </td>
                    <td className="px-4 py-3 hidden xl:table-cell">
                      <span
                        className={`text-sm font-medium ${
                          overdue ? "text-[#DC143C]" : "text-gray-600"
                        }`}
                      >
